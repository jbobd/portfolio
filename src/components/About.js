        ...
        <div className="about" id="about">
            <div className="aboutContent">
                <div className="aboutPortfolio">
                    ...
                    <img alt="Calm, zen workspace built for productivity" className="homeContent__cam"src={require('../img/camara.jpg')}></img>                
                </MediaQuery>
                </div>
                <div className="aboutContent__info">
                    <div className="aboutContent__bio">
                        <h2 className="subtitle aboutContent__bio-subtitle aboutContent__bio-subtitle-1">My office is everywhere</h2>
                        <p className="aboutContent__info-bio aboutContent__bio-body-1">
                            <p className="homeContent__p3">I have worked two and a half years in Europe, where I gained a lot of experiences and new perspectives, So I am very experienced in working with people from different countries and places.</p>
                            <p className="homeContent__p3">I am also a hobbyst photographer!</p>
                    ...
                    <div className="aboutContent__skills">
                        ...
                        <div className="skills">
                            <ul className="skills__frontEnd">
                                ...
                                <li className="skills__frontEnd-item">Redux</li>
                            ...
                            <ul className="skills__backEnd">
                                ...
                                <li className="skills__backEnd-item">PHP</li>
                                <li className="skills__backEnd-item">Firebase</li>
                                <li className="skills__backEnd-item">REST APIs</li>
                            </ul>
                            <ul className="skills__qa">
                                <li className="skills__qa-title"><b>Languages</b></li>
